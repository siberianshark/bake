...
import renderBakeCards from "./offer/bake_grid.js";
...
export let bakeCardsGrid;
// HTML template for a park-related card
export let bakeCardTemplate;
...
const prepareDOMElements = () => {
  ...
  // Grid container for park-related cards
  bakeCardsGrid = document.querySelector(".bake__grid");
  // HTML template for a park-related card
  bakeCardTemplate = document.querySelector(".bake__template");
  // Map box
